...
meditations_full = meditations_book_1 + meditations_book_2 + meditations_book_3 + meditations_book_4 + meditations_book_5 + meditations_book_6 + meditations_book_7 + meditations_book_8 + meditations_book_9 + meditations_book_10 + meditations_book_11 + meditations_book_12

# User input, which book they want to search for.
meditations_book_to_search = input("Which book would you like to search? (1 - 12, or 13 to search all the books.): ")
